    ...
    venues: [
      {
        ...
        telephone: '069 870 087 70',
        openingHours: [
          {
            label: 'Montag bis Freitag',
            opens: '11:00',
            closes: '23:30',
            notes: 'Andere Quelle nennt 14:00-23:00 Uhr wochentags; vor Buchung prüfen.',
          },
          {
            label: 'Samstag und Sonntag',
            opens: '09:00',
        ...
        pricing: {
          ...
          lastVerifiedAt: '2026-09-06',
          notes:
            'Doppelcourt: Nebenzeit 18-20 € pro Stunde (Mo-Fr bis 17 Uhr), Hauptzeit 28 € (ab 17 Uhr sowie Wochenende), inkl. Flutlicht. Single-Court laut Drittanbieter ca. 14-22 €. Einzeltraining 35 €, Doppeltraining 50 € pro Stunde (zzgl. Platzmiete).',
        },
        ratings: [],
        notes:
          'Größte Padel-Anlage Frankfurts mit eigener Padel-Schule und drei Single-Courts. Neun reine Outdoor-Courts (6 Doppel + 3 Single laut mehreren unabhängigen Quellen).',
        sources: [
          {
            name: 'official_website',
            url: 'https://www.sportpark-frankfurt.de/sport/padel-tennis',
            checkedAt: '2026-09-06',
            confidence: 'high',
          },
          {
          ...
          {
            name: 'other',
            url: 'https://www.ffh.de/nachrichten/magazin/474130-padel-tennis-in-hessen-spielen-alle-plaetze-im-ueberblick.html',
            checkedAt: '2026-09-06',
            confidence: 'medium',
          },
        ],
      ...
      },
      {
        ...
        telephone: '+49 69 751920',
        openingHours: [
          {
            label: 'Täglich',
            opens: '08:00',
            closes: '22:00',
            notes: 'Buchung direkt über Playtomic.',
          },
        ],
        courts: {
          total: 3,
        ...
        pricing: {
          ...
          lastVerifiedAt: '2026-09-06',
          notes:
            "Laut Vereinsangabe pro Person abgerechnet: Mitglieder 5 € p.P. (20 € pro Court), Nichtmitglieder 9 € p.P. (36 € pro Court). Bälle 6 € (Kauf). Preisangabe konnte nicht durch eine unabhängige Drittquelle verifiziert werden, da die Vereinsseite technisch keine Preisliste ausliefert; Konfidenz daher auf 'medium' gesetzt.",
        },
        ratings: [],
        notes:
          'Neuer 24.000 m² Sport-Campus des jüdischen Sportvereins TuS Makkabi, am 14. Juni 2026 nach 21 Mio. € Bauinvestition eröffnet (mehrfach presseseitig bestätigt: FR, t-online, Jüdische Allgemeine). Drei Outdoor-Padel-Courts als Teil der Gesamtanlage mit zwei Kunstrasen-Großfeldern, Basketballhalle und Parkour-Areal. Ab Frühjahr 2027 sollen laut Verein zusätzlich offizielle Trainings und Mannschaftsbetrieb starten; aktuell nur Privatbuchung über Playtomic möglich.',
        sources: [
          {
            name: 'official_website',
          ...
          {
            name: 'padelcompass',
            url: 'https://padelcompass.de/plaetze/hessen/frankfurt-am-main/makkabi-campus-frankfurt-am-main',
            checkedAt: '2026-09-06',
            confidence: 'medium',
          },
          {
            name: 'other',
            url: 'https://www.fr.de/frankfurt/ginnheim-ort904319/tus-makkabi-eroeffnet-21-millionen-euro-campus-mit-basketball-halle-94348656.html',
            checkedAt: '2026-09-06',
            confidence: 'high',
          },
        ],
        editorial: {
          ...
          shortDescription:
            'Drei moderne Outdoor-Courts auf dem neuen, 21-Millionen-Euro-Campus des TuS Makkabi in Ginnheim, frei buchbar über Playtomic.',
          lastHumanReviewAt: '2026-09-06',
        },
      },
      {
        ...
        openingHours: [
          {
            label: 'Montag bis Freitag (Saison)',
            opens: '12:00',
            closes: '22:00',
            notes: 'Padel-Courts haben eigenen Zugang und sind laut Betreiber auch außerhalb der regulären Club-Öffnungszeiten bespielbar.',
          },
          {
            label: 'Wochenende und Feiertage (Saison)',
            opens: '15:00',
            closes: '22:00',
            notes: null,
          },
        ...
        pricing: {
          ...
          lastVerifiedAt: '2026-09-06',
          notes:
            'Korrigiert gegenüber ursprünglicher Annahme von ca. 20 €: Zwei unabhängige Presseartikel (FR, Mai 2025 und April 2026) sowie Padelscout bestätigen übereinstimmend 40-44 € pro Stunde für den Doppelcourt. Schläger im Verleih-Automat 5 €, Bälle 8 € (Kauf). Zusätzlich Club-Eintritt ab 18-20 Uhr (5-8 €, variiert je nach Quelle und Saison).',
        },
        ratings: [],
        notes:
          'Saisonale Anlage (ca. April-September) inmitten der Frankfurter Skyline im Bankenviertel. Parken ca. 5 Gehminuten entfernt im Holiday Inn (Mainzer Landstraße 27) möglich.',
        sources: [
          {
            name: 'official_website',
          ...
          {
            name: 'other',
            url: 'https://www.fr.de/frankfurt/bahnhofsviertel-ort904309/der-gibson-beach-club-oeffnet-wieder-und-darf-auch-naechstes-jahr-bleiben-94265555.html',
            checkedAt: '2026-09-06',
            confidence: 'high',
          },
          {
            name: 'other',
            url: 'https://padelscout.io/de-de/clubs/gibson-beach-club',
            checkedAt: '2026-09-06',
            confidence: 'medium',
          },
        ],
        editorial: {
          ...
          shortDescription:
            'Einzigartige Sand-Location im Gibson Beach Club mit Drinks und direktem Blick auf die Frankfurter Skyline.',
          lastHumanReviewAt: '2026-09-06',
        },
      },
      {
        ...
        ratings: [],
        notes:
          "Bestätigtes, aber noch nicht eröffnetes Projekt: laut offizieller Skyline-Plaza-Seite entsteht mit dem 'JPadel Club' bis Frühjahr 2027 ein Rooftop-Padel-Angebot im 'Skyline Garden' auf dem Dach des Einkaufszentrums. Vier Plätze mit Skyline-Blick und direktem Zugang zur Gastronomie des Centers geplant. Status bewusst auf 'research' belassen, bis konkrete Buchungsmöglichkeit besteht.",
        sources: [
          {
            name: 'other',
        ...
        editorial: {
          ...
          recommendedFor: [],
          shortDescription:
            'Spektakuläres Rooftop-Padel-Projekt auf dem Dach des Skyline Plaza, geplante Eröffnung Frühjahr 2027.',
          lastHumanReviewAt: '2026-09-06',
        },
      },
    ],
